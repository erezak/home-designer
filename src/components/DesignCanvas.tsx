...
export function DesignCanvas({ canvasRef }: DesignCanvasProps) {
  ...
  return (
    <div className="flex-1 overflow-auto p-8 text-slate-100">
      {/* View Title */}
      ...
      >
            <div className="flex justify-center">
              ...
              <div className="relative" style={{ padding: '40px 60px 40px 70px' }}>
                ...
                >
                  ...
                  <div className="absolute inset-0 border-2 border-white/30 pointer-events-none" style={{ zIndex: 500 }} />
              ...
              {state.canvas.showAllDistances && gaps.map((gap, index) => {
                ...
                return (
                  ...
                  >
                    <span className="bg-emerald-400/90 text-slate-900 text-xs px-1 rounded whitespace-nowrap shadow">
            ...
            <div className="absolute top-2 left-0 right-0 flex justify-center pointer-events-none" style={{ paddingLeft: 70, paddingRight: 60 }}>
              <span className="bg-white/20 text-white text-xs px-2 py-0.5 rounded border border-white/30 backdrop-blur-sm">
            ...
            <div className="absolute left-2 top-0 bottom-0 flex items-center pointer-events-none" style={{ paddingTop: 40, paddingBottom: 40 }}>
              <span className="bg-white/20 text-white text-xs px-2 py-0.5 rounded whitespace-nowrap -rotate-90 border border-white/30 backdrop-blur-sm">
