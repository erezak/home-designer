      ...
      >
        <div className="flex justify-center">
          <div className="relative" style={{ padding: '40px 60px 40px 70px' }}>
            <div
              ref={ref}
              className="relative bg-white border border-slate-200 shadow-[0_24px_60px_-32px_rgba(79,70,229,0.45)]"
              style={{
                width: canvasWidth,
                height: canvasHeight,
            ...
            >
              <div
                className="absolute inset-0 border-2 border-slate-300 pointer-events-none shadow-inner"
                style={{ zIndex: 500 }}
              />
              ...
              {state.canvas.showAllDistances &&
                gaps.map((gap, index) => {
                  ...
                  return (
                    ...
                    >
                      <span className="bg-amber-100 text-amber-700 text-xs px-2 py-0.5 rounded-full border border-amber-200 shadow-sm whitespace-nowrap">
            ...
            <div
              ...
              style={{ paddingLeft: 70, paddingRight: 60 }}
            >
              <span className="bg-slate-800 text-white text-xs px-2 py-0.5 rounded shadow-sm">
            ...
            >
              <span className="bg-slate-800 text-white text-xs px-2 py-0.5 rounded whitespace-nowrap -rotate-90 shadow-sm">
                {formatCm(
                  state.activeView === 'elevation'
                    ? state.canvas.dimensions.height
                    : state.canvas.dimensions.depth
